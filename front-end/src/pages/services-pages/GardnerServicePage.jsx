...
import { blackbg, gard, gard11, gard12, gard13 } from '../../assets/images';
import { gardeningTestimonials, partnerLogos } from '../../constants';
  ...
  return (
    <div className="container-fluid px-0" style={{ background: 'linear-gradient(to bottom, #1F2937, #D1D5DB)' }}>
      <div className="container mx-auto px-4 py-8" >
        ...
        <PageTitle title="Gardening Services" />
        
        {/* Hero Section */}
        <section className="mb-8 flex flex-wrap items-center justify-center rounded-3xl" style={{ backgroundImage: `url(${gard})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', minHeight: '600px' }}>
          <div className="rounded-3xl m-6" style={{textAlign: 'center', color: '#fff', fontFamily: 'Montserrat', backgroundColor: 'rgba(0, 0, 0, 0.5)', padding: '20px', boxSizing: 'border-box'}}>
            <h1 className=' text-3xl font-bold text-slate-100'>Welcome to our expert gardening services! </h1>
            <p className='text-xl text-slate-100'>
              <Typewriter text="Whether you have a residential garden or a commercial landscape, we provide comprehensive solutions to enhance the beauty and vitality of your outdoor spaces. Our skilled team offers professional landscaping, meticulous lawn care, precise pruning, and creative design to transform your garden into a flourishing oasis." delay={50}/>
            </p>
          </div>
        </section>
        ...
        <section className=" my-20">
          ...
          <h1 className="text-lg text-gray-200 mb-6 font-montserrat">
            Our gardening services cater to both residential and commercial properties. We offer a variety of landscaping solutions designed to meet your specific needs. From routine lawn maintenance to landscape design and specialized services for corporate campuses and public spaces, our experienced team ensures exceptional results every time.          </h1>
          <ServiceCategory title="Residential Gardning Services">
          ...
          <ServiceCategory title="Commercial Gardning Services">
            <div className="mt-6 flex flex-wrap gap-4">
        ...
        <section className="mt-8">
          <h2 className="text-4xl font-bold font-montserrat text-slate-100 mb-8 text-center">Why Choose Our Gardening Services</h2>
            ...
            <FlippingCard
              ...
              frontContent={
                <div className="p-4 rounded-lg m-2" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', }}>
                  <h3 className="text-2xl font-semibold text-center font-montserrat text-white">Experienced Gardeners</h3>
                </div>
              }
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">Our gardeners are highly experienced and trained to deliver top-quality gardening services.</p>
                </div>
              }
            />
            <FlippingCard
              ...
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">We use eco-friendly products to ensure the safety of your family and the environment.</p>
                </div>
              }
            />
            <FlippingCard
              ...
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">We offer customized gardening solutions tailored to meet your specific needs and preferences.</p>
                </div>
              }
            />
          </div>
        ...
        <section className="py-12 px-4 bg-gray-900 text-white my-20 rounded-3xl" ref={ref}>
          ...
          >
            {gardeningTestimonials.map((testimonial, index) => (
              <motion.div
                key={index}
...
export default GardnerServicePage