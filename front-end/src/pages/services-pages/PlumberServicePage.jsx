...
import { blackbg, plumb21, plumb22, plumb23, plumbcov } from '../../assets/images';
import { partnerLogos, plumbingTestimonials } from '../../constants';
  ...
  return (
    <div className="container-fluid px-0" style={{ background: 'linear-gradient(to bottom, #1F2937, #D1D5DB)' }}>
      <div className="container mx-auto px-4 py-8" >
        ...
        <PageTitle title="Plumbing Services" />
        
        {/* Hero Section */}
        <section className="mb-8 flex flex-wrap items-center justify-center rounded-3xl" style={{ backgroundImage: `url(${plumbcov})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', minHeight: '600px' }}>
          <div className="rounded-3xl m-6" style={{textAlign: 'center', color: '#fff', fontFamily: 'Montserrat', backgroundColor: 'rgba(0, 0, 0, 0.5)', padding: '20px', boxSizing: 'border-box'}}>
            <h1 className=' text-3xl font-bold text-slate-100'>Welcome to our professional plumbing services!</h1>
            <p className='text-xl text-slate-100'>
              <Typewriter text="Whether it's a leaky faucet, a clogged drain, or a major pipe repair, our team is here to provide expert solutions for all your plumbing needs. With our experienced technicians and state-of-the-art equipment, we deliver reliable service to ensure your plumbing systems run smoothly and efficiently, leaving your home or business in top condition." delay={50}/>
            </p>
          </div>
        </section>
        ...
        <section className=" my-20">
          ...
          <h1 className="text-lg text-gray-200 mb-6 font-montserrat">
            Our plumbing services cater to both residential and commercial properties, offering a range of solutions to address various plumbing needs. From repairing leaks and installing fixtures in homes to handling complex plumbing systems in commercial buildings, our experienced team delivers reliable and efficient service. We prioritize precision, professionalism, and timely solutions to ensure the smooth operation of your plumbing systems.</h1>

          <ServiceCategory title="Residential Plumbing Services">
          ...
          <ServiceCategory title="Commercial Plumbing Services">
            <div className="mt-6 flex flex-wrap gap-4">
        ...
        <section className="mt-8">
          <h2 className="text-4xl font-bold font-montserrat text-slate-100 mb-8 text-center">Why Choose Our Plumbing Services</h2>
            ...
            <FlippingCard
              ...
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">Our staff is highly experienced and trained to deliver top-quality plumbing services.</p>
                </div>
              }
            />
            <FlippingCard
              ...
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">We use eco-friendly plumbing tools to ensure the safety of your family and the environment.</p>
                </div>
              }
            />
            <FlippingCard
              ...
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">We offer customized plumbing solutions tailored to meet your specific needs and preferences.</p>
                </div>
              }
            />
          </div>
        ...
        <section className="py-12 px-4 bg-gray-900 text-white my-20 rounded-3xl" ref={ref}>
          ...
          >
            {plumbingTestimonials.map((testimonial, index) => (
              <motion.div
                key={index}
...
export default PlumberServicePage