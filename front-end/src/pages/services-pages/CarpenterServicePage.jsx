...
import { blackbg, carp1, carp12, carp13, carp14 } from '../../assets/images';
import { carpentryTestimonials, partnerLogos } from '../../constants';
  ...
  return (
    <div className="container-fluid px-0" style={{ background: 'linear-gradient(to bottom, #1F2937, #D1D5DB)' }}>
      <div className="container mx-auto px-4 py-8" >
        ...
        <PageTitle title="Carpentering Services" />
        
        {/* Hero Section */}
        <section className="mb-8 flex flex-wrap items-center justify-center rounded-3xl" style={{ backgroundImage: `url(${carp1})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', minHeight: '600px' }}>
          <div className="rounded-3xl m-6" style={{textAlign: 'center', color: '#fff', fontFamily: 'Montserrat', backgroundColor: 'rgba(0, 0, 0, 0.5)', padding: '20px', boxSizing: 'border-box'}}>
            <h1 className=' text-3xl font-bold text-slate-100'>Carpentry Craftsmanship at its Finest!</h1>
            <p className='text-xl text-slate-100'>
              <Typewriter text="Welcome to our carpentry services, where precision meets perfection. From custom furniture to intricate woodwork, our skilled craftsmen deliver exceptional results that elevate your space. Trust us for quality carpentry solutions tailored to your needs." delay={50}/>
            </p>
          </div>
        </section>
        ...
        <section className=" my-20">
          ...
          <h1 className="text-lg text-gray-200 mb-6 font-montserrat">
            Our carpentry services are tailored for both residential and commercial projects. We specialize in crafting custom furniture, installing interior trims, cabinets, and decks for homes, while also offering office furniture installation, retail display construction, and restaurant interior design for commercial spaces. Our skilled team delivers quality craftsmanship to enhance the functionality and aesthetics of your property.          </h1>
          <ServiceCategory title="Residential Carpentry Services">
          ...
          <ServiceCategory title="Commercial Carpentry Services">
            <div className="mt-6 flex flex-wrap gap-4">
        ...
        <section className="mt-8">
          <h2 className="text-4xl font-bold font-montserrat text-slate-100 mb-8 text-center">Why Choose Our Carpentry Services</h2>
          <div className="flex justify-center gap-6">
            <FlippingCard
              ...
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">Our staff is highly experienced and trained to deliver top-quality services.</p>
                </div>
              }
            />
            <FlippingCard
            ...
            <FlippingCard
              ...
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">We offer customized solutions tailored to meet your specific needs and preferences.</p>
                </div>
              }
            />
          </div>
        ...
        <section className="py-12 px-4 bg-gray-900 text-white my-20 rounded-3xl" ref={ref}>
          ...
          >
            {carpentryTestimonials.map((testimonial, index) => (
              <motion.div
                key={index}
