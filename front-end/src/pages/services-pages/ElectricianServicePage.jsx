...
import { blackbg, electricalhero, electrician14, electrician15, electrician16 } from '../../assets/images';
import { electricalTestimonials, partnerLogos } from '../../constants';
  ...
  return (
    <div className="container-fluid px-0" style={{ background: 'linear-gradient(to bottom, #1F2937, #D1D5DB)' }}>
      ...
      <div className="container mx-auto  px-4 py-8" >
        ...
        <PageTitle title="Electrical Services" />
        
        {/* Hero Section */}
        <section className="mb-8 flex flex-wrap items-center justify-center rounded-3xl" style={{ backgroundImage: `url(${electricalhero})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', minHeight: '600px' }}>
          <div className="rounded-3xl m-6" style={{textAlign: 'center', color: '#fff', fontFamily: 'Montserrat', backgroundColor: 'rgba(0, 0, 0, 0.5)', padding: '20px', boxSizing: 'border-box'}}>
            <h1 className=' text-3xl font-bold text-slate-100'>Welcome to our expert electrical services! </h1>
            <p className='text-xl text-slate-100'>
              <Typewriter text="From routine maintenance to complex installations, we provide comprehensive solutions for residential and commercial electrical needs. Our skilled technicians use cutting-edge equipment and adhere to safety standards to deliver reliable and efficient service, ensuring your property is powered up safely and efficiently." delay={50}/>
            </p>
          </div>
        </section>
        ...
        <section className=" my-20">
          ...
          <h1 className="text-lg text-gray-200 mb-6 font-montserrat">
            From residential homes to commercial establishments, our electrical services are designed to meet diverse needs. Whether it's fixing wiring issues, upgrading electrical systems, or providing interim IT support, our professional team ensures prompt and efficient service delivery. We prioritize safety, efficiency, and customer satisfaction in every project, ensuring optimal performance and reliability.</h1>

          <ServiceCategory title="Residential Electrical Services">
          ...
          <ServiceCategory title="Commercial Electrical Services">
            <div className="mt-6 flex flex-wrap gap-4">
        ...
        <section className="mt-8">
          <h2 className="text-4xl font-bold font-montserrat text-slate-100 mb-8 text-center">Why Choose Our Electrical Services</h2>
          <div className="flex justify-center gap-6">
            <FlippingCard
              frontImage={electrician14}
              backImage={blackbg}
              frontContent={
              ...
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">Our staff is highly experienced and trained to deliver top-quality electrical services.</p>
                </div>
              }
            />
            <FlippingCard
              frontImage={electrician15}
              backImage={blackbg}
              frontContent={
                <div className="p-4 rounded-lg m-2" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
                  <h3 className="text-2xl font-semibold text-center font-montserrat text-white">Eco-Friendly Products</h3>
                </div>
              }
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">We use eco-friendly products and practices to ensure the safety of your property and the environment.</p>
                </div>
              }
            />
            <FlippingCard
              frontImage={electrician16}
              backImage={blackbg}
              frontContent={
                <div className="p-4 rounded-lg m-2" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
                  <h3 className="text-2xl font-semibold text-center font-montserrat text-white">Customized Solutions</h3>
                </div>
              }
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">We offer customized electrical solutions tailored to meet your specific needs and preferences.</p>
                </div>
              }
            />
          </div>
        ...
        <section className="py-12 px-4 bg-gray-900 text-white my-20 rounded-3xl" ref={ref}>
          ...
          >
            {electricalTestimonials.map((testimonial, index) => (
              <motion.div
                key={index}
