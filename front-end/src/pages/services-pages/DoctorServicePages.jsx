...
import { blackbg, doc, doc11, doc12, doc13 } from '../../assets/images';
import { medicalTestimonials, partnerLogos } from '../../constants';
  ...
  return (
    <div className="container-fluid px-0" style={{ background: 'linear-gradient(to bottom, #1F2937, #D1D5DB)' }}>
      <div className="container mx-auto px-4 py-8" >
        ...
        <PageTitle title="Medical Services" />
        
        {/* Hero Section */}
        <section className="mb-8 flex flex-wrap items-center justify-center rounded-3xl" style={{ backgroundImage: `url(${doc})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', minHeight: '800px' }}>
          <div className="rounded-3xl m-6" style={{textAlign: 'center', color: '#fff', fontFamily: 'Montserrat', backgroundColor: 'rgba(0, 0, 0, 0.5)', padding: '20px', boxSizing: 'border-box'}}>
            <h1 className=' text-3xl font-bold text-slate-100'>Welcome to our comprehensive medical services! </h1>
            <p className='text-xl text-slate-100'>
              <Typewriter text="We provide a diverse range of healthcare solutions tailored for individuals and businesses alike. With our skilled professionals and state-of-the-art facilities, we deliver exceptional care using the latest medical advancements, ensuring your well-being is our top priority." delay={50}/>
            </p>
          </div>
        </section>
        ...
        <section className=" my-20">
          ...
          <h1 className="text-lg text-gray-200 mb-6 font-montserrat">
            Our medical services cater to both individual and corporate needs, providing a comprehensive range of healthcare solutions tailored to your requirements. From routine check-ups to specialized treatments and programs for workplaces and organizations, our dedicated team ensures top-quality care and support for all your medical needs.
          </h1>
          <ServiceCategory title="Residential Medical Services">
          ...
          <ServiceCategory title="Commercial Medical Services">
            <div className="mt-6 flex flex-wrap gap-4">
        ...
        <section className="mt-8">
          <h2 className="text-4xl font-bold font-montserrat text-slate-100 mb-8 text-center">Why Choose Our Medical Services</h2>
            ...
            <FlippingCard
              ...
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">Our staff is highly experienced and trained to deliver top-quality medical services.</p>
                </div>
              }
            />
            <FlippingCard
              ...
              frontContent={
                <div className="p-4 rounded-lg m-2" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
                  <h3 className="text-2xl font-semibold text-center font-montserrat text-white">State-of-the-Art Equipment</h3>
                </div>
              }
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">We utilize cutting-edge medical equipment and technology to ensure accurate diagnoses and effective treatments for our patients.</p>
                </div>
              }
            />
            <FlippingCard
              ...
              frontContent={
                <div className="p-4 rounded-lg m-2" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
                  <h3 className="text-2xl font-semibold text-center font-montserrat text-white">Personalized Care Plans</h3>
                </div>
              }
              backContent={
                <div className="rounded-xl" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', width: '100%', height: '100%' }}>
                  <p className="text-xl font-semibold text-slate-100 text-center font-montserrat pt-40">We develop personalized care plans tailored to meet the unique medical needs and preferences of each patient.</p>
                </div>
              }
            />
          </div>
...
export default DoctorServicePages